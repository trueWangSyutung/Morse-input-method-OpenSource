            ...
            MorseInputMethodTheme {
                Scaffold(modifier = Modifier.fillMaxSize()) { innerPadding ->
                    Column(
                        ...
                        Column(
                            modifier = Modifier
                                .background(getDarkModeBackgroundColor(context = this@AboutActivity, level = 0))
                                .padding(innerPadding)
                        ...
                        Row(
                            modifier = Modifier
                                ...
                                .background(getDarkModeBackgroundColor(context = this@AboutActivity, level = 0), shape = RoundedCornerShape(15.dp))
                                .clickable {
                            ...
                            Text(
                                text = resources.getString(R.string.open_source),
                                color = getDarkModeTextColor(this@AboutActivity),
                                fontSize = 15.sp,
                                fontWeight = FontWeight.Medium,
                            )
                        ...
                        Row(
                            ...
                            Text(
                                text = resources.getString(R.string.privacy_desp),
                                color = getDarkModeTextColor(this@AboutActivity),
                                fontSize = 15.sp,
                                fontWeight = FontWeight.Medium,
                            )
                        ...
                        Row(
                            ...
                            Text(
                                text = resources.getString(R.string.open_source_lib),
                                color = getDarkModeTextColor(this@AboutActivity),
                                fontSize = 15.sp,
                                fontWeight = FontWeight.Medium,
                            )
